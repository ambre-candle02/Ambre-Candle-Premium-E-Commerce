...
function CollectionContent() {
    ...
    const filterGroups = {
        'All': [],
        'Gift': ['Hampers | Combo', 'Rakhi', 'Valentines', 'Baby Shower', 'Bouquet Candle'],
        'Festive': ['Christmas', 'Diwali', 'Halloween | Fall', 'Ladoo Candle'],
        'Artisan': ['Concrete Base Candle', 'Cake / Dessert Candle', 'Doll Candle', 'Flower Heart Candle', 'Pillar Candle', 'Wooden Base Candle', 'Urli Candle'],
        'Jar': ['Glass Jar Candle', 'Coconut Shell Candle', 'Tin Jar Candle'],
        'Daily Luxe': ['Wax Melts', 'Wax Sachet', 'Tealight', 'Favourites']
    };
