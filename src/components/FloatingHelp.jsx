...
export default function FloatingHelp() {
    ...
    const containerStyle = {
        position: 'fixed',
        bottom: isMobile ? '135px' : '40px', /* Shifted up on mobile to completely clear the Checkout button */
        right: isMobile ? '20px' : '40px',  /* More breathable margin from the edge */
        zIndex: 10000,
        display: 'flex',
    ...
    return (
        <div style={containerStyle}>
            ...
            >
                {isOpen ? <X size={isMobile ? 24 : 28} /> : <HelpCircle size={isMobile ? 28 : 32} color="#d4af37" />}
            </motion.button>
        </div>
    );
}
