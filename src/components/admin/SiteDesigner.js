...
export default function SiteDesigner() {
    ...
    const [config, setConfig] = useState({
        hero: {
            home: '', shop: '', collection: '', about: '', contact: '', wishlist: '', cart: ''
        },
        auth: {
            login: '', signup: '', forgot: ''
        },
        ...
        collections: {
            'Gift': '', 'Festive': '', 'Decor': '', 'Jar': '', 'Diwali': '',
            'Christmas': '', 'Halloween | Fall': '', 'Ladoo Candle': '',
            'Hampers | Combo': '', 'Rakhi': '', 'Concrete Base Candle': '',
            'Cake / Dessert Candle': '', 'Baby Shower': '', 'Glass Jar Candle': '',
